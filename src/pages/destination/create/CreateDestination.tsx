...
import { MapContainer, TileLayer, Marker, useMapEvents
...
function MapResize() {
  ...
  const mutation = useMutation({
    mutationFn: (newDestination: DestinationForm) => {
      ...
      return Service.AddDestination(formData);
    },
    onSuccess: () => {
          ...
          <Box sx={{ p: 4 }}>
            ...
            <form onSubmit={handleSubmit}>
              <Stack spacing={2}>
                ...
                >
                  {mutation.isPending ? "جاري الإضافة..." : "إضافة الوجهة"}
                </Button>
              </Stack>
            </form>
          </Box>
  ...
  <DialogContent>
    ...
    >
      <MapContainer style={{ height: 500, width: "100%" }}>
